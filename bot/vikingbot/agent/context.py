        ...
        if ov_tools_enable:
            ...
            if viking_memory:
                ...
                parts.append(
                    ...
                    "- For yes/no or permission-style questions, judge the exact wording or action proposed by the user and answer it first with a direct yes or no; if it overstates evidence, crosses scope, or violates a remembered constraint, answer no before offering a safer alternative, even if a revised wording or action would be acceptable.\n"
